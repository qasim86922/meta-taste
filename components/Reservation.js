...
import { View,ImageBackground,FlatList,  Image, Text, TouchableOpacity, StyleSheet } from "react-native";
...
const [searchData,setData] = React.useState([])
 ...
 <View style = {styles.row}> 
     ...
     renderItem={(data) => (
       ...
       <TouchableOpacity style={styles.container} onPress={() => onPressReserve(data.item))}>
